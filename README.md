...
🌐 **Live Application**: [cs-4610-pokedex.vercel.app](https://cs-4610-pokedex.vercel.app)

## Features

- **Searchable Lists**: Browse and search through Pokémon, locations, moves, and generations
- **Detailed Information**: View comprehensive details for each Pokémon, including stats, sprites, locations, and moves
