          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={`
                  lg:px-6 lg:py-4 px-3 py-2 text-xs lg:text-sm font-semibold whitespace-nowrap border-b-2 transition-colors focus:outline-none focus:border-red-300 focus:bg-gray-50
                  ${isActive
