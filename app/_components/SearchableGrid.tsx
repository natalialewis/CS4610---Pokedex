          ...
          {filteredItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={href}
                className="bg-blue-100/50 hover:bg-red-100/20 focus:bg-red-100/50 rounded-lg shadow-md hover:shadow-lg focus:shadow-lg transition-shadow p-2 lg:p-4 border-2 border-blue-900 hover:border-[var(--pokemon-red)] focus:border-[var(--pokemon-red)] focus:outline-none group"
              >
